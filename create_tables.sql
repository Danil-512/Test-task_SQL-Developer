...
insert all 
  ...
  into CLIENTS (PCODE, FULLNAME) values (4, 'Владимир Владимирович')
  into CLIENTS (PCODE, FULLNAME, BDATE) values (5, 'Петр Петрович', to_date('03.03.2003', 'dd.mm.yyyy'))
select * from dual
;
...
create table CLHISTNUM (
  ...
  AMOUNTRUB decimal(20, 2),                                          -- Страховая сумма
